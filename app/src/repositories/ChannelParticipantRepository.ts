...
export class ChannelParticipantRepository {
  ...
  /**
   * Get active participants with user display info (name, email, role)
   * JOIN channel_participants with users to get human-readable names
   */
