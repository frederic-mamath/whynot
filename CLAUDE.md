...
Features are tracked in `features/` with numbered folders (`001-039`). See `features/CLAUDE.md` for the feature-ticketing protocol (atomic daily-deliverable tickets, app must build at every step).
